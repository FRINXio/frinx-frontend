                    ...
                    <Row>
                        ...
                        <Col className="whiteBg" xs="6">
                            <div className="loginWindow">
                                ...
                                <center>
                                    <Form>
                                        <InputGroup className={!this.state.activeUseremail ? "pretty-feild paddedFeild" : "input-email pretty-feild paddedFeild focusedInput"}>
                                            <InputGroup.Prepend>
                                        ...
                                        <InputGroup className={!this.state.activePassword ? "pretty-feild paddedFeild" : "input-password pretty-feild paddedFeild focusedInput"}>
                                            <InputGroup.Prepend>
