...
export type ResourcePool = Node & {
  ...
  DealocationSafetyPeriod: Scalars['Int'];
  Name: Scalars['String'];
...
export type AllocationStrategiesQuery = { __typename?: 'Query', QueryAllocationStrategies: Array<{ __typename?: 'AllocationStrategy', id: string, Name: string, Lang: AllocationStrategyLang, Script: string }> };
