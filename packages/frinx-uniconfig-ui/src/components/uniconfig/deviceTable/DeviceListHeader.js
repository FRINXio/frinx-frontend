  ...
  return (
    <div className={classes.wrapper}>
      ...
      <div className={classes.btnContainer}>
        <div>
          <Badge
            badgeContent={props.checked.length === 1 ? `as ${props.checked[0]?.nodeId}` : null}
            anchorOrigin={{
              vertical: 'bottom',
              horizontal: 'left',
            }}
        ...
        <div>
          <Button variant="outlined" className={classes.buttons} startIcon={<RefreshIcon />} onClick={props.fetchData}>
            Refresh Devices
          </Button>
        </div>
      </div>
